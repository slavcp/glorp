...
pub const DEFAULT_FLAGS: &str = r#"[
  ...
  "--disable-features=TextureLayerSkipWaitForActivation,CalculateNativeWinOcclusion",
  ...
  "--enable-features=BlinkCompositorUseDisplayThreadPriority,GpuUseDisplayThreadPriority,BrowserUseDisplayThreadPriority",
