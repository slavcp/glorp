	...
	set(value) {
		if (value) {
			...
			import("./settings.js").then(() => {
				...
				if (window.glorpClient?.settings.config?.showPing) import("./modules/showPing.js");
				if (window.glorpClient?.settings.config?.showChangelog) import("./modules/changelog.js");
